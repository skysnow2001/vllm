...
# NOTE: DSv4 editable COPY of _triton_kernels/fusions/fused_reduce_qk_norm_rope_swa_write.py
# Verbatim kernel; adapt for DeepSeek-V4 qnorm+RoPE+KV-insert (see launcher notes).
